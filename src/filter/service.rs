...
///
/// Filters are normally what APIs are built on in starterm. However, it can be
...
/// # Example
///
/// Running a `starterm::Filter` on a regular `hyper::Server`:
///
/// ```
...
///
/// // Our Filter...
/// let route = starterm::any().map(|| "Hello From Starterm!");
///
/// // Convert it into a `Service`...
/// let svc = starterm::service(route);
///
/// // Typical hyper setup...
