...
/// ```
///
/// For more examples, please take a look at [examples/query_string.rs](https://github.com/commandlinedev/starterm-server/blob/master/examples/query_string.rs).
///
