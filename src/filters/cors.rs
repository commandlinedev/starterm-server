...
///     .allow_any_origin();
/// ```
/// You can find more usage examples [here](https://github.com/commandlinedev/starterm-server/blob/7fa54eaecd0fe12687137372791ff22fc7995766/tests/cors.rs).
pub fn cors() -> Builder {
    Builder {
        credentials: false,
...
/// A wrapping [`Filter`](crate::Filter) constructed via `starterm::cors()`.
#[derive(Clone, Debug)]
pub struct Cors {
    config: Arc<Configured>,
}

/// A constructed via `starterm::cors()`.
#[derive(Clone, Debug)]
pub struct Builder {
    credentials: bool,
