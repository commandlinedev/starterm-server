...
//! use starterm::Filter;
//!
//! let with_server = starterm::reply::with::header("server", "starterm");
//!
...
/// let route = starterm::any()
///     .map(starterm::reply)
///     .with(starterm::reply::with::header("foo", "bar"));
/// ```
...
/// let route = starterm::any()
///     .map(starterm::reply)
///     .with(starterm::reply::with::headers(headers));
/// ```
...
/// use starterm::Filter;
///
/// // Set `server: starterm` if not already set.
/// let route = starterm::any()
///     .map(starterm::reply)
///     .with(starterm::reply::with::default_header("server", "starterm"));
/// ```
