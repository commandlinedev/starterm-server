...
/// let content_length = starterm::header::<u64>("content-length");
///
/// // Parse `host: 127.0.0.1:8080` as a `SocketAddr
/// let local_host = starterm::header::<SocketAddr>("host");
///
/// // Parse `foo: bar` into a `String`
/// let foo = starterm::header::<String>("foo");
/// ```
...
/// let opt_auth = starterm::header::optional::<String>("authorization");
/// ```
pub fn optional<T>(
    name: &'static str,
...
/// let must_dnt = starterm::header::exact("dnt", "1");
/// ```
pub fn exact(
    name: &'static str,
    value: &'static str,
...
/// let keep_alive = starterm::header::exact_ignore_case("connection", "keep-alive");
/// ```
...
///
/// ```
/// use starterm::{Filter, http::header::HeaderValue};
///
/// let filter = starterm::header::value("x-token")
...
///
/// ```
/// use starterm::{Filter, http::HeaderMap};
///
/// let headers = starterm::header::headers_cloned()
