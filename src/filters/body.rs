...
/// let upload = starterm::body::content_length_limit(4096)
///     .and(starterm::body::aggregate());
/// ```
...
///
/// For example usage, please take a look at [examples/stream.rs](https://github.com/commandlinedev/starterm-server/blob/master/examples/stream.rs).
///
/// # Warning
///
...
///
/// ```
/// use starterm::{Buf, Filter};
///
/// let route = starterm::body::content_length_limit(1024 * 32)
///     .and(starterm::body::bytes())
