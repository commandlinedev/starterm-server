...
///
/// let multihost =
///     starterm::host::exact("foo.com").map(|| "you've reached foo.com")
///     .or(starterm::host::exact("bar.com").map(|| "you've reached bar.com"));
/// ```
...
///
/// ```
/// use starterm::{Filter, host::Authority};
///
/// let host = starterm::host::optional()
