...
//! }
//!
//! let app = starterm::path("push-notifications")
//!     .and(starterm::get())
//!     .map(|| {
//!         starterm::sse::reply(starterm::sse::keep_alive().stream(sse_events()))
//!     });
//! ```
//!
...
///
/// ```
/// let app = starterm::sse::last_event_id::<u32>();
///
...
///
/// async {
///     let app = starterm::path("sse").and(starterm::get()).map(|| {
...
/// use starterm::{Filter, Stream, sse::Event};
///
...
///
/// fn main() {
///     let routes = starterm::path("ticks")
///         .and(starterm::get())
///         .map(|| {
...
///             let stream = starterm::sse::keep_alive()
///                 .interval(Duration::from_secs(5))
///                 .text("thump".to_string())
///                 .stream(event_stream);
///             starterm::sse::reply(stream)
///         });
/// }
/// ```
///
