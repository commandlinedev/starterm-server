...
///
/// let route = starterm::path("v1")
///     .map(|| {
///         starterm::redirect(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = starterm::path("v1")
///     .map(|| {
///         starterm::redirect::found(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = starterm::path("v1")
///     .map(|| {
///         starterm::redirect::see_other(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = starterm::path("v1")
///     .map(|| {
///         starterm::redirect::temporary(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = starterm::path("v1")
///     .map(|| {
///         starterm::redirect::permanent(Uri::from_static("/v2"))
///     });
/// ```
...
mod sealed {
    ...
    /// arguments could be accepted, like maybe just `starterm::redirect("/v2")`.
